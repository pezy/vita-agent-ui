...
try:  # optional dependency; safe to skip if not installed
    ...
    steps = [
        # TTS Start
        {
            ...
            "event": {
                ...
                "text": "Hello! I will check that for you.",
                "provider": "bridge",
            },
        },
        ...
        },
        {
            ...
            "result": {
                "status": "ok",
                "data": {"answer": "It looks like a clear, sunny day with calm water."},
        ...
        {
            "type": "ui_event",
            "event": {"event_type": "vision_2d_detection_start", "method": "vlm"},
        },
        {"type": "ui_event", "event": {"event_type": "vision_3d_start"}},
        {
            "type": "ui_event",
            "event": {"event_type": "vision_3d_depth_complete", "duration_ms": 200},
        },
        {
            "type": "ui_event",
            "event": {
                ...
                "detections": [
                    {"label": "bridge", "x1": 0.1, "y1": 0.2, "x2": 0.5, "y2": 0.6}
                ],
                "detection_count": 1,
                "duration_ms": 300,
            },
        ...
        },
        {
            ...
            "result": {
                "status": "ok",
                "data": {
                    "objects": [{"label": "bridge", "distance": 25.0, "angle_deg": 0.0}]
                },
